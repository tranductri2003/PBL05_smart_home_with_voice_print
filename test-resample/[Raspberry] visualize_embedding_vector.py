...
convert_sample_rate(r"/home/tranductri2003/Code/PBL05_smart_home_with_voice_print_and_antifraud_ai/test-resample/[Raspberry] Recording/Đạt/[Raspberry] [Đạt] Giảm chỗ học lớp 10.wav", r"/home/tranductri2003/Code/PBL05_smart_home_with_voice_print_and_antifraud_ai/test-resample/[Raspberry] Recording/Đạt/[Raspberry] [Đạt] Giảm chỗ học lớp 10.wav", 16000)
...
print(Color.BOLD + "Cosine similarity between " + Color.BLUE + "raspberry_dat_giam_cho_hoc_lop_10_embedding" + Color.ENDC + " and " + Color.BLUE + "raspberry_dat_chieu_cao_cau_thu_audio_path" + Color.ENDC + ":", similarity_raspberry_dat_giam_cho_hoc_lop_10_raspberry_dat_chieu_cao_cau_thu)
